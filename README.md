...
- Adicionar domínio: `claude.roilabs.com.br`
...
### **Health check:**
```bash
curl https://claude.roilabs.com.br/health
```

### **Verificar autenticação:**
```bash
curl -H "x-api-secret: mcp-claude-evolution-2025-secure" \
     https://claude.roilabs.com.br/info
```

### **Listar instâncias:**
```bash
curl -H "x-api-secret: mcp-claude-evolution-2025-secure" \
     https://claude.roilabs.com.br/api/instances/list
```
...
curl -X POST \
  ...
  https://claude.roilabs.com.br/api/messages/Teste/text
```
...
curl -X POST \
  ...
  https://claude.roilabs.com.br/api/groups/Teste/create
```
...
curl -X POST \
  ...
  https://claude.roilabs.com.br/api/chatwoot/Teste/set
```
...
URL: https://claude.roilabs.com.br
...
docker run -p 3002:3002 --env-file .env mcp-evolution-api
```
...
### **Logs do container:**
```bash
# No Easypanel, vá em Services > claude > Logs
```
